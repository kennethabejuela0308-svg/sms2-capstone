...
$flashOk = '';
$flashErr = '';
if (($_GET['notice'] ?? '') === 'assign-dh-only') {
    $flashErr = 'Only the Department Head may assign Research Coordinator and Adviser. You can Approve or Decline assignments here.';
}
