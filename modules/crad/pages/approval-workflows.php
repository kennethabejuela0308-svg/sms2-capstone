<?php
/**
 * SMS 2 - REVIEW & WORKFLOW · Approval Workflows
 * Module: CRAD
 *
 * Navigation placeholder — the approval workflow is not implemented yet.
 */
...
$pageBannerDescription = 'Manage research grant proposal approval workflows.';
...
<div class="mpl" data-mpl>
    <section class="mpl-panel">
        <div style="text-align:center;padding:3.5rem 1.5rem;">
            ...
            <h2 style="font-size:1.05rem;font-weight:800;color:var(--sms-heading);margin-bottom:.4rem;">Approval Workflows</h2>
