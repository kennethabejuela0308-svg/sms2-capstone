        ...
        <?php if (!empty($progressUpdates)): ?>
            <div class="d-flex flex-column gap-4" data-updates-container>
                ...
                ?>
                    ...
                    <!-- Comment Modal -->
                    <div class="modal fade rm-modal" id="feedbackModal<?= $updateId ?>" tabindex="-1">
                    ...
                    <!-- Revision Modal -->
                    <div class="modal fade rm-modal" id="revisionModal<?= $updateId ?>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                    ...
                    <!-- Approve Modal -->
                    <div class="modal fade rm-modal" id="approveModal<?= $updateId ?>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
