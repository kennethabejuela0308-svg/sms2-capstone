...
?>
<aside class="sms-sidebar <?= in_array($roleKey, ['superadmin', 'admin'], true) ? 'admin-sidebar' : '' ?> <?= ($roleKey === 'research_director' && $activeModule === 'faculty') ? 'research-director-sidebar' : '' ?>" id="smsSidebar" aria-label="Main navigation">
