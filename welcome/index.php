<?php
/**
 * SMS 2 - Welcome page (removed from the system flow)
 *
 * The obsolete welcome landing page no longer participates in the workflow.
 * Visiting this URL now routes the visitor to the correct destination:
